import '../complete/complete_widget.dart';
...
class _PaymentWidgetState extends State<PaymentWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color(0x4B57636C),
      body: SafeArea(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText:
                                'ที่อยู่สำหรับจัดส่ง : นายจน รวยมาก | (+66) 95 456 7895 26 \nหมู่ 2 ตำบลแม่กา อำเภอเมือง\nจังหวัดพะเยา, 56000',
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            'ฝากข้อความถึงเจ้าของบริษัทขนส่ง',
                                        enabledBorder: UnderlineInputBorder(
                                          borderSide: BorderSide(
                                            color: Color(0x00000000),
                                            width: 1,
